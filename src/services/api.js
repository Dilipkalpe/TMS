...
export const accountingApi = {
  ...
  ledgerMaster: (params = {}) => apiRequest(`/accounting/ledger-master?${new URLSearchParams(params)}`),
  ...
  journalRegister: (params = {}) => apiRequest(`/accounting/journal-register?${new URLSearchParams(params)}`),
  receiptRegister: (params = {}) => apiRequest(`/accounting/receipt-register?${new URLSearchParams(params)}`),
  paymentRegister: (params = {}) => apiRequest(`/accounting/payment-register?${new URLSearchParams(params)}`),
  purchaseRegister: (params = {}) => apiRequest(`/accounting/purchase-register?${new URLSearchParams(params)}`),
  salesRegister: (params = {}) => apiRequest(`/accounting/sales-register?${new URLSearchParams(params)}`),
