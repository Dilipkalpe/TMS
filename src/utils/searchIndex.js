...
async function buildIndex() {
  ...
  lrs.forEach((l) => items.push({ id: l.lrNumber, label: l.lrNumber, sub: `${l.from} → ${l.to}`, path: `/lr/${encodeURIComponent(l.lrNumber)}`, keywords: `${l.lrNumber} ${l.consignor} ${l.consignee}`.toLowerCase() }))
