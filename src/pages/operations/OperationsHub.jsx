...
export default function OperationsHub() {
  ...
  return (
    <ERPContentPage module="Operations" title="Enterprise Modules">
      <p className="mb-4 text-sm text-slate-500">
        All Enterprise TMS modules are now available in TMS Pro — customer portal, GPS, fuel, ePOD, finance, and more.
      </p>
