...
import { incomeReport } from '../../data/reports'
...
export default function IncomeReport() {
  ...
  const columns = [
    ...
    { key: 'loading', label: 'Loading', render: (r) => formatCurrency(r.loading) },
  ...
  return (
    <ERPListPage
      ...
      module="Reports"
      title="Income Report"
      statusCards={registerStatusCards('Total Months', incomeReport.length, 'green', 'TrendingUp')}
showActions={false}
      searchKeys={['month']}
      columns={columns}
      data={incomeReport}
