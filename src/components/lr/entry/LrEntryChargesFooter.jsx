...
/** Charge inputs moved from Section 5 — same bindings, compact footer row. */
export default function LrEntryChargesFooter({ form, update }) {
  return (
    <div className="lr-entry-v2-charges-footer" id="lr-section-charges">
      <Select
        label="Freight Type"
