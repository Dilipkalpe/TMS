import {
  Columns3, Download, Filter, Layers, Plus, Printer, RefreshCw, Search,
} from 'lucide-react'

export default function LrListActionBar({
  onNew,
  onNewBulk,
  onSearch,
  onExport,
    ...
    <div className="flex flex-wrap items-center justify-between gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2.5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          type="button"
          onClick={onNewBulk}
          className="inline-flex items-center gap-2 rounded-md border border-primary bg-primary/5 px-4 py-2 text-sm font-semibold text-primary shadow-sm hover:bg-primary/10"
        >
