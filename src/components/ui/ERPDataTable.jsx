...
export default function ERPDataTable({
  ...
  const allColumns = [
    ...
    ...(showActions ? [{ key: '__action', label: 'Action', width: 'w-28' }] : []),
    ...columns,
  ]
                      ...
                      <td key={col.key} className={`border border-primary/10 ${cellPad}`}>
                        <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                          <button
                            ...
                            title="Print"
                            onClick={() => onPrint?.(row)}
                            className="inline-flex h-7 w-7 items-center justify-center rounded bg-primary text-white hover:bg-primary-dark"
                          >
                          ...
                          <button
                            ...
                            title="Edit"
                            onClick={() => onEdit?.(row)}
                            className="inline-flex h-7 w-7 items-center justify-center rounded border border-primary/40 bg-white text-primary hover:bg-primary/10 dark:bg-slate-800"
                          >
                          ...
                          <button
                            ...
                            className="inline-flex h-7 w-7 items-center justify-center rounded border border-red-300 bg-white text-red-500 hover:bg-red-50 dark:bg-slate-800"
                          >
