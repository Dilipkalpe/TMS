...

{
...

    {
        ...
        return ok
            ...
            ? Results.Ok(new { status = "healthy", service = "TMS Pro API", database = "connected", build = "2026-07-11-hr-employee-v3" })

            : Results.Json(new { status = "unhealthy", service = "TMS Pro API", database = "disconnected", build = "2026-07-11-hr-employee-v3" }, statusCode: 503);
