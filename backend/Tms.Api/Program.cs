...

{
...

    {
        ...
        return ok
            ...
            ? Results.Ok(new { status = "healthy", service = "TMS Pro API", database = "connected", build = "2026-07-12-mobile-ui" })

            : Results.Json(new { status = "unhealthy", service = "TMS Pro API", database = "disconnected", build = "2026-07-12-mobile-ui" }, statusCode: 503);
