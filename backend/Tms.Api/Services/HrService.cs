...
public class HrService(IConfiguration config, ITenantContext tenants)
{
    ...
    public async Task<Guid> SaveEmployeeAsync(SaveEmployeeRequest body, CancellationToken ct = default)
    {
        ...
        cmd.Parameters.Add(NpgsqlParameterHelper.Text("p_driver", body.DriverId));
        cmd.Parameters.Add(NpgsqlParameterHelper.Text("p_email", body.Email));
        cmd.Parameters.Add(NpgsqlParameterHelper.Text("p_phone", body.Phone));
        ...
        cmd.Parameters.Add(NpgsqlParameterHelper.Text("p_gender", body.Gender));
        cmd.Parameters.Add(NpgsqlParameterHelper.Text("p_address", body.Address));
        cmd.Parameters.Add(NpgsqlParameterHelper.Text("p_bank", body.BankAccount));
        cmd.Parameters.Add(NpgsqlParameterHelper.Text("p_ifsc", body.BankIfsc));
        cmd.Parameters.Add(NpgsqlParameterHelper.Text("p_pan", body.Pan));
        ...
        cmd.Parameters.Add(NpgsqlParameterHelper.Text("p_license", body.LicenseNumber));
        cmd.Parameters.Add(NpgsqlParameterHelper.Date("p_license_exp", body.LicenseExpiry));
        cmd.Parameters.Add(NpgsqlParameterHelper.Text("p_vehicle", body.AssignedVehicleId));
