...
CREATE UNIQUE INDEX IF NOT EXISTS idx_geofence_assign_all
    ON geofence_assignments(geofence_id) WHERE applies_to_all = true;
CREATE UNIQUE INDEX IF NOT EXISTS idx_geofence_assign_vehicle
    ON geofence_assignments(geofence_id, vehicle_id) WHERE vehicle_id IS NOT NULL;
